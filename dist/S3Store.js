...
S3Store = function (_StorageAdapter) {(0, _inherits3.default)(S3Store, _StorageAdapter);
  ...
  {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref$collectionPrefix = _ref.collectionPrefix,collectionPrefix = _ref$collectionPrefix === undefined ? "fc_sa_s3." : _ref$collectionPrefix,db = _ref.db,fileKeyMaker = _ref.fileKeyMaker,mongodb = _ref.mongodb,name = _ref.name,transformRead = _ref.transformRead,transformWrite = _ref.transformWrite;(0, _classCallCheck3.default)(this, S3Store);var _this = (0, _possibleConstructorReturn3.default)(this, (S3Store.__proto__ || (0, _getPrototypeOf2.default)(S3Store)).call(this,
    {
    ...
    typeName = "s3";_this.s3 = new _s2.default({ apiVersion: "2006-03-01", region: process.env.AWS_S3_REGION });_this.collectionName = ("" + collectionPrefix + name).trim();return _this;}(0, _createClass3.default)(S3Store, [{ key: "_fileKeyMaker", value: function _fileKeyMaker(fileRecord) {var info = fileRecord.infoForCopy(this.name);var result = { _id: info.key || null, filename: info.name || fileRecord.name() || fileRecord.collectionName + "-" + fileRecord._id, size: info.size };(0, _debug2.default)("S3Store _fileKeyMaker result:", result);return result;} /**
