...
S3Store = function (_StorageAdapter) {(0, _inherits3.default)(S3Store, _StorageAdapter);
  ...
  {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref$collectionPrefix = _ref.collectionPrefix,collectionPrefix = _ref$collectionPrefix === undefined ? "fc_sa_s3." : _ref$collectionPrefix,fileKeyMaker = _ref.fileKeyMaker,name = _ref.name,transformRead = _ref.transformRead,transformWrite = _ref.transformWrite;(0, _classCallCheck3.default)(this, S3Store);var _this = (0, _possibleConstructorReturn3.default)(this, (S3Store.__proto__ || (0, _getPrototypeOf2.default)(S3Store)).call(this,
    {
